...
if (empty($site['LID']))
{
	\CAdminMessage::ShowMessage(
		Loc::getMessage('HDDEN_REDIRECT_SITE_NOT_DEFINED')
	);
	return;
}
...
if (check_bitrix_sessid() && $request->isPost())
{
	if ($request->getPost('save') != '')
	{
		...
		if ($request->get('hdden_action') == 'redirects')
		{
		...
		\CAdminMessage::ShowNote(
			Loc::getMessage('HDDEN_REDIRECT_SETTINGS_SAVED')
		);
	}
}
...
if ($request->get('hdden_action') == 'redirects')
{
	$description = Loc::getMessage('HDDEN_REDIRECT_TITLE_REDIRECTS');
}
else
{
	$description = Loc::getMessage('HDDEN_REDIRECT_OPTIONS_TITLE');
}
...
<form method="post" action="">
	...
	<?php if ($request->get('hdden_action') == 'redirects') { ?>
						...
						<tr data-idx="<?= $i ?>">
							<td>
								<input type="text" placeholder="<?=
										Loc::getMessage("HDDEN_REDIRECT_URLS_FROM") ?>"
							...
							<td>
								<input type="text" placeholder="<?=
										Loc::getMessage("HDDEN_REDIRECT_URLS_TO") ?>"
							...
							<td>
								<select name="redirect_urls[<?= $i ?>][2]"
										title="<?= Loc::getMessage("HDDEN_REDIRECT_URLS_STATUS") ?>"
										style="width:96%;">
							...
							<td>
								<input name="redirect_urls[<?= $i ?>][3]" value="Y" type="checkbox"
									title="<?= Loc::getMessage("HDDEN_REDIRECT_URLS_IS_PART_URL") ?>"
									<?= $url[3] == "Y"? "checked" : "" ?>>
							</td>
						</tr>
					<?php } ?>
	...
	<tr>
		<td class="adm-detail-content-cell-l" width="50%">
			<label>
				<?= Loc::getMessage("HDDEN_REDIRECT_OPTIONS_WWW_TITLE") ?>
			</label>
		</td>
	...
	<tr>
		<td class="adm-detail-content-cell-l" width="50%">
			<label>
				<?= Loc::getMessage("HDDEN_REDIRECT_OPTIONS_TOWWW_TITLE") ?>
			</label>
		</td>
		<td class="adm-detail-content-cell-r" width="50%">
			<input name="redirect_towww" value="Y" type="checkbox"
				<?= $currentOptions["redirect_towww"] == "Y"? "checked" : "" ?>>
		</td>
	</tr>
	...
	<tr>
		<td class="adm-detail-content-cell-l" width="50%">
			<label>
				<?= Loc::getMessage("HDDEN_REDIRECT_OPTIONS_HTTPS_TITLE") ?>
			</label>
		</td>
		<td class="adm-detail-content-cell-r" width="50%">
			<label>
	...
	<tr>
		<td class="adm-detail-content-cell-l" width="50%">
			<label>
				<?= Loc::getMessage("HDDEN_REDIRECT_OPTIONS_SLASH_TITLE") ?>
			</label>
		</td>
		<td class="adm-detail-content-cell-r" width="50%">
	...
	<tr>
		<td class="adm-detail-content-cell-l" width="50%">
			<label>
				<?= Loc::getMessage("HDDEN_REDIRECT_OPTIONS_INDEX_TITLE") ?>
			</label>
		</td>
		<td class="adm-detail-content-cell-r" width="50%">
	...
	<tr>
		<td class="adm-detail-content-cell-l" width="50%">
			<label>
				<?= Loc::getMessage("HDDEN_REDIRECT_OPTIONS_MULTISLASH_TITLE") ?>
			</label>
		</td>
		<td class="adm-detail-content-cell-r" width="50%">
	...
	<tr>
		<td class="adm-detail-content-cell-l" width="50%">
			<label>
				<?= Loc::getMessage("HDDEN_REDIRECT_IGNORE_QUERY") ?>
			</label>
		</td>
		<td class="adm-detail-content-cell-r" width="50%">
	...
	<tr>
		<td class="adm-detail-content-cell-l" width="50%">
			<label>
				<?= Loc::getMessage("HDDEN_REDIRECT_FROM_404") ?>
			</label>
		</td>
		<td class="adm-detail-content-cell-r" width="50%">
	...
	<tr>
		<td class="adm-detail-content-cell-l" width="50%">
			<label>
				<?= Loc::getMessage("HDDEN_REDIRECT_URLS_TITLE") ?>
			</label>
		</td>
		<td class="adm-detail-content-cell-r" width="50%">
	...
	<input class="adm-btn-save" type="submit" name="save"
		value="<?= Loc::getMessage("HDDEN_REDIRECT_SAVE_SETTINGS") ?>">
